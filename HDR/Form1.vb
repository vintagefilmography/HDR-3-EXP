            ...
            If ImageCount > 1 Then
                If SequenceCount = 1 Then
                    ...
                    If TiffToggle = 1 Then
                        ...
                        imFullpath1 = impath1 + "\" + Str(ImageSaveCount) + ".tiff"
                    Else
                        'imFullpath1 = impath1 + "\" + Str(ImageOdd) + ".jpg"
                        imFullpath1 = impath1 + "\" + Str(ImageSaveCount) + ".jpg"
                    End If
                ...
                If SequenceCount = 2 Then
                    ...
                    If TiffToggle = 1 Then
                        ...
                        imFullpath2 = impath2 + "\" + Str(ImageSaveCount) + ".tiff"
                    Else
                        'imFullpath2 = impath2 + "\" + Str(ImageEven) + ".jpg"
                        imFullpath2 = impath2 + "\" + Str(ImageSaveCount) + ".jpg"
                    End If
